...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="shop_table shop_table_responsive">
		...
		<div class="cart-subtotal">
			<h3><?php esc_html_e( 'Сумма', 'woocommerce' ); ?></h3>
			...
			if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) {
				foreach ( WC()->cart->get_tax_totals() as $code => $tax ) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
					...
					<div class="tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
						<h3><?php echo esc_html( $tax->label ) . $estimated_text; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h3>
				...
				?>
				<div class="tax-total">
					<h3><?php echo esc_html( WC()->countries->tax_or_vat() ) . $estimated_text; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h3>
		...
		<div class="order-total">
			<h3><?php esc_html_e( 'Общая стоимость', 'woocommerce' ); ?></h3>
